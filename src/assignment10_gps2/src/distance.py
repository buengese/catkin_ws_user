...
def getClosestPoint(pos, distance, laneID):
	if laneID == 1:
		...
		c2 = (4.14, 2.20)
		r = 1.27
		# Verwendete Koordinaten entsprechen nicht ganz dem was wir in dem Bild gemessen haben führen so aber zu deutlich besseren Ergebnissen
	if laneID == 2:
		p1 = (1.85, .47)
		p2 = (4.14, .47)
		p3 = (1.85, 3.84)
